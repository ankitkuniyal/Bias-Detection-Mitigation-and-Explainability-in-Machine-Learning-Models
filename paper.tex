...
To validate the differences between the mitigation techniques, we conducted paired $t$-tests across the 5 seeds (degrees of freedom $df=4$) comparing Exponentiated Gradient against the baseline RF, Threshold Adjustment, and Adversarial Debiasing. On the Adult dataset, Exponentiated Gradient's improvement in Equal Opportunity was statistically significant compared to RF ($t = -28.29, p < 0.001$), Threshold Adjustment ($t = -9.92, p < 0.001$), and Adversarial Debiasing ($t = -3.59, p = 0.023$). Its MCC was also significantly higher than Threshold Adjustment's ($t = 18.97, p < 0.001$). On the COMPAS dataset, Exponentiated Gradient significantly improved Equal Opportunity over baseline RF ($t = -13.85, p < 0.001$) and Adversarial Debiasing ($t = -5.08, p = 0.007$), with no significant difference in Equal Opportunity compared to Threshold Adjustment ($t = -1.31, p = 0.26$). On the German Credit dataset, Exponentiated Gradient significantly improved Equal Opportunity over baseline RF ($t = -4.77, p = 0.009$), with no significant difference compared to Threshold Adjustment ($t = -2.02, p = 0.11$) or Adversarial Debiasing ($t = -1.45, p = 0.22$). These results confirm that reductions-based in-processing reliably matches or exceeds post-processing calibration without predictive distortion.
