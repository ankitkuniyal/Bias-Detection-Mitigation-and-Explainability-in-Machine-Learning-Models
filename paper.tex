...
To validate the differences between the mitigation techniques, we conducted paired $t$-tests across the 5 seeds (degrees of freedom $df=4$) comparing Exponentiated Gradient against the baseline RF, Threshold Adjustment, and Adversarial Debiasing, reporting both t-statistics and Cohen's $d$ effect sizes. On the Adult dataset, Exponentiated Gradient's improvement in Equal Opportunity was statistically significant compared to RF ($t = -28.29, p < 0.001, d = -12.65$), Threshold Adjustment ($t = -14.34, p < 0.001, d = -6.41$), and Adversarial Debiasing ($t = -3.59, p = 0.023, d = -1.61$). Its MCC was also significantly higher than Threshold Adjustment's ($t = 25.58, p < 0.001, d = 11.44$). On the COMPAS dataset, Exponentiated Gradient significantly improved Equal Opportunity over baseline RF ($t = -13.85, p < 0.001, d = -6.19$) and Adversarial Debiasing ($t = -5.08, p = 0.007, d = -2.27$), with no significant difference in Equal Opportunity compared to Threshold Adjustment ($t = -1.31, p = 0.26, d = -0.59$). On the German Credit dataset, Exponentiated Gradient significantly improved Equal Opportunity over baseline RF ($t = -4.77, p = 0.009, d = -2.13$), with no significant difference compared to Threshold Adjustment ($t = -2.02, p = 0.11, d = -0.90$) or Adversarial Debiasing ($t = -1.45, p = 0.22, d = -0.65$). These results confirm that reductions-based in-processing reliably matches or exceeds post-processing calibration without predictive distortion, yielding very large effect sizes ($|d| > 1.5$) where improvements are significant.
